...
Meu nome é **Thiago Monteiro**, tenho 19 anos e sou desenvolvedor backend e estudante de Desenvolvimento de Software Multiplataforma na Fatec Praia Grande.
  
Gosto muito da área de cibersegurança, especialmente de pentesting.
...
<details>
  ...
  ![MongoDB Atlas](https://img.shields.io/badge/-MongoDB%20Atlas-256b8b?style=for-the-badge&logo=mongodb&logoColor=white)
...
#### 🌎 Idiomas  
- **Português**: nativo
- **Inglês**: leitura e escrita avançadas, conversação básica (em evolução)
