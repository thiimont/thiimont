...
Hi, I'm **Thiago Monteiro**, a Cross-Platform Software Development student at Fatec and a backend developer focused on creating **efficient, robust and scalable solutions**. :octocat:
...
- **Linux**: Using for more than 4 years (daily usage and development)
- **Git**: Repository management/code versioning (GitHub)
- **Eclipse/VS Code**: Eclipse for Java development and VS Code for other languages (like Python and PHP) or frontend things
- **Burp Suite**: For pentesting/security analysis purposes
...
<p>🎯 My goal is to <b>expand my knowledge and contribute to projects with commitment</b></p>
<p>💬 Ask me about <b>pentesting</b></p>
